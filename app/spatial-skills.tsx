...
export default function SpatialSkillsPage() {
	const [drawerOpen, setDrawerOpen] = useState(false);
	return (
		<View style={styles.container}>
			<HeaderBar onMenuPress={() => setDrawerOpen(true)} title="Spatial Skills" />
			...
			>
				...
				<View style={styles.drawerContainer}>
					<DrawerMenu onClose={() => setDrawerOpen(false)} currentRoute="/spatial-skills" />
				</View>
			</Modal>
		</View>
	);
