...
export default function MentalCalculationPage() {
	...
	return (
		<View style={styles.container}>
			<HeaderBar onMenuPress={() => setDrawerOpen(true)} title="Mental Calculation" />
			<View style={styles.contentWrapper}>
				<MentalCalculationScreen />
			</View>
			<Modal
				visible={drawerOpen}
				animationType="slide"
			...
			>
				...
				<View style={styles.drawerContainer}>
					<DrawerMenu onClose={() => setDrawerOpen(false)} currentRoute="/mental-calculation" />
				</View>
			</Modal>
		</View>
	);
